...
function displayPics() {
  ...
  // The scope of the vartiable rando is the outer while loop as it is declared with let now. This variable is in scope   // in both the while loops but not outside of the while loops. The console log is outside the while loops. The variable //is out of scope here.
